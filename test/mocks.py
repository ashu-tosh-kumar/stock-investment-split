...
FINANCIAL_INSTRUMENTS_MODELS = [FinancialInstrument(**financial_instrument_dict) for financial_instrument_dict in _financial_instrument_list]
DUMMY_FINANCIAL_INSTRUMENTS = FinancialInstruments(instruments=FINANCIAL_INSTRUMENTS_MODELS)
